...
<body id="dark">
  <header class="dark-bb">
    <nav class="navbar navbar-expand-lg">
      <a class="navbar-brand" href="exchange-dark.html"><img src="assets/img/logo-light.png') }}" alt="logo"></a>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-3">
          <div class="nav flex-column nav-pills settings-nav" id="v-pills-tab" role="tablist"
            ...
            <a class="nav-link active" id="settings-tab" data-toggle="pill" href="#settings" role="tab"
                  ...
                  <div class="col-md-12 col-lg-4">
                    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                      <a class="nav-link d-flex justify-content-between align-items-center active" data-toggle="pill"
                        ...
                        <div class="d-flex">
                          <img src="{{ asset('crypo/assets/img/icon/18.png') }}" alt="btc">
                          <div>
                            <h2>BTC</h2>
                            <p>Bitcoin</p>
                          </div>
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" data-toggle="pill"
                        ...
                        <div class="d-flex">
                          <img src="{{ asset('crypo/assets/img/icon/1.png') }}" alt="btc">
                          <div>
                            <h2>ETH</h2>
                            <p>Ethereum</p>
                          </div>
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" data-toggle="pill"
                        ...
                        <div class="d-flex">
                          <img src="{{ asset('crypo/assets/img/icon/9.png') }}" alt="btc">
                          <div>
                            <h2>BNB</h2>
                            <p>Binance</p>
                          </div>
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" data-toggle="pill"
                        ...
                        <div class="d-flex">
                          <img src="{{ asset('crypo/assets/img/icon/6.png') }}" alt="btc">
                          <div>
                            <h2>TRX</h2>
                            <p>Tron</p>
                          </div>
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" data-toggle="pill"
                        ...
                        <div class="d-flex">
                          <img src="{{ asset('crypo/assets/img/icon/2.png') }}" alt="btc">
                          <div>
                            <h2>EOS</h2>
                            <p>Eosio</p>
                          </div>
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" data-toggle="pill"
                        ...
                        <div class="d-flex">
                          <img src="{{ asset('crypo/assets/img/icon/7.png') }}" alt="btc">
                          <div>
                            <h2>XMR</h2>
                            <p>Monero</p>
                          </div>
                      ...
                      <a class="nav-link d-flex justify-content-between align-items-center" data-toggle="pill"
                        ...
                        <div class="d-flex">
                          <img src="{{ asset('crypo/assets/img/icon/4.png') }}" alt="btc">
                          <div>
                            <h2>KCS</h2>
                            <p>Kstarcoin</p>
                          </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="row wallet-address">
                              ...
                              <div class="col-md-4">
                                <img src="{{ asset('crypo/assets/img/qr-code-light.svg') }}" alt="qr-code">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card">
                          <div class="card-body">
                            ...
                            <div class="row wallet-address">
                              ...
                              <div class="col-md-4">
                                <img src="{{ asset('crypo/assets/img/qr-code-light.svg') }}ß" alt="qr-code">
                              </div>
                            </div>
                          </div>
                        </div>
