...
Route::get('/', function (){
   ...
   return view('maintemplate/index');
});


Route::get('/admin-panel', function(){
  return view('crypo/admin');
});

Route::get('/crypo', function (){
  return view('crypo/exchange-dark');
})->middleware('auth');


Route::get('/wallet', function (){
  return view('crypo/settings-wallet-dark');
})->middleware('auth');
...
Route::get('/profile', function (){
  return view('crypo/settings-profile-dark');
})->middleware('auth');


Route::get('/settings', function (){
  return view('crypo/settings-dark');
})->middleware('auth');
...
Route::get('/symbol-info', function (){
  return view('crypo/symbol-info-dark');
})->middleware('auth');


Route::get('/r-password', function (){
  return view('crypo/reset-password-dark');
})->middleware('auth');
